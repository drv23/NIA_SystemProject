...
// Get the equipment type from the route parameter (if provided)
const equipmentType = computed(() => {
  // Capitalize the first letter for display purposes
  const type = route.params.type || 'equipment'
...
// Sample data for all equipment types
const items = ref([
  {
    article: 'Desktop',
    description: 'Intel Core i5-650 2GB memory',
    propertyCode: 'DDN-IMO-F501 223-C02 05-10',
    unitValue: '32,200.00',
    dateAcquired: '12-28-10',
    poNumber: '2010-12-0579',
    location: 'Billing Unit/M.Torres',
    condition: 'A3 Servicable'
  },
  {
    article: 'Desktop',
    description: 'Samsung EX2020 Led Monitor',
    propertyCode: 'DDN-IMO-F501 223-C02 05-10',
    unitValue: '32,200.00',
    dateAcquired: '12-28-10',
    poNumber: '2010-12-0579',
